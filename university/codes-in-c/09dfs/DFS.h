...
class Aresta {
    public: 
        ...
        Aresta(int id, int id_vertice_origem = -1, int id_vertice_destino = -1, int peso = -1, int visitado = 0);
        virtual ~Aresta();
        void print_aresta();
...
class Grafo {
    public: 
        ...
        void visita_aresta(int vertice_origem, int vertice_destino);
        int verifica_se_ja_visitou(int vertice_origem, int vertice_destino);
